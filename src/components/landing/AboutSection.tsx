      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          ...
          <div className="relative group">
            ...
            {/* Decorative elements */}
            <div
              className="absolute -bottom-6 -right-6 w-32 h-32 rounded-3xl -z-10 transition-all duration-700 group-hover:translate-x-2 group-hover:translate-y-2"
              style={{ backgroundColor: 'rgba(201,169,97,0.15)' }}
            />
            <div
              className="absolute -top-6 -left-6 w-24 h-24 rounded-full -z-10 transition-all duration-700 group-hover:-translate-x-1 group-hover:-translate-y-1"
